...
import org.nexus.commons.NexusBeanScope;
import org.nexus.commons.NexusConfig;
import org.nexus.core.config.ServerConfig;
import org.nexus.core.server.NexusServer;
import org.nexus.database.NexusDatabaseMigrator;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

/**
 * Base class for Nexus applications. Extend this class to create a new Nexus application.
 */
public abstract class NexusApplication {
  ...
  /**
   * Creates the server configuration. Can be overridden to provide custom configuration.
   */
  ...
  /**
   * Configures the server before starting. Override this method to customize server configuration.
   *
  ...
  /**
   * Initializes database connections. Override this method to customize database initialization.
   */
  ...
  /**
   * Creates the Nexus server instance. Can be overridden to provide a custom server
   * implementation.
   */
