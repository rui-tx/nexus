...
class MappingProcessorTest {
  ...
  void shouldGenerateExactRoute() throws IOException {
    ...
    JavaFileObject controllerSource = JavaFileObjects.forSourceString(
        "org.nexus.annotations.test.TestController",
        """
            package org.nexus.annotations.test;
    ...
    assertThat(generatedSource).contains("""
        private static void initRoutes() {
            exactRoutes.put("GET " + PathMatcher.normalise("/route"), new Route<java.lang.String>(HttpMethod.GET, "/route", rc -> {
                        org.nexus.annotations.test.TestController controller = org.nexus.commons.NexusBeanScope.get().get(org.nexus.annotations.test.TestController.class);
                      try {
            ...
            dynamicRoutesByMethod.computeIfAbsent("GET", k -> new ArrayList<>())
                .add(new CompiledRoute(CompiledPattern.compile("/entry/:pathParam1"),
                    new Route<java.lang.String>(HttpMethod.GET, "/entry/:pathParam1", rc -> {
                      java.lang.String pathParam1 = rc.getPathParams().get("pathParam1");  org.nexus.test.TestController controller = org.nexus.commons.NexusBeanScope.get().get(org.nexus.test.TestController.class);
                      try {
            ...
            dynamicRoutesByMethod.computeIfAbsent("GET", k -> new ArrayList<>())
                .add(new CompiledRoute(CompiledPattern.compile("/entry/:pathParam1/:pathParam2"),
                    new Route<java.lang.String>(HttpMethod.GET, "/entry/:pathParam1/:pathParam2", rc -> {
                      java.lang.String pathParam1 = rc.getPathParams().get("pathParam1");java.lang.Integer pathParam2 = safeParseInt(rc.getPathParams().get("pathParam2"), "pathParam2", "/entry/:pathParam1/:pathParam2");  org.nexus.test.TestController controller = org.nexus.commons.NexusBeanScope.get().get(org.nexus.test.TestController.class);
                      try {
    ...
    assertThat(generatedSource).contains("""
        private static void initRoutes() {
            exactRoutes.put("GET " + PathMatcher.normalise("/entry"), new Route<java.lang.String>(HttpMethod.GET, "/entry", rc -> {
                      java.lang.String queryParam1 = rc.getQueryParam("queryParam1");java.lang.Integer queryParam2 = safeParseIntQuery(rc.getQueryParam("queryParam2"), "queryParam2", "/entry");  org.nexus.test.TestController controller = org.nexus.commons.NexusBeanScope.get().get(org.nexus.test.TestController.class);
                      try {
    ...
    assertThat(generatedSource).contains("""
        private static void initRoutes() {
          dynamicRoutesByMethod.computeIfAbsent("GET", k -> new ArrayList<>())
              .add(new CompiledRoute(CompiledPattern.compile("/entry/:pathParam1"),
                  new Route<java.lang.String>(HttpMethod.GET, "/entry/:pathParam1", rc -> {
                    java.lang.String pathParam1 = rc.getPathParams().get("pathParam1");java.lang.String queryParam1 = rc.getQueryParam("queryParam1");java.lang.Integer queryParam2 = safeParseIntQuery(rc.getQueryParam("queryParam2"), "queryParam2", "/entry/:pathParam1");  org.nexus.test.TestController controller = org.nexus.commons.NexusBeanScope.get().get(org.nexus.test.TestController.class);
                    try {
